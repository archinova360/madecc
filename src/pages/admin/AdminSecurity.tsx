...
export default function AdminSecurity() {
  ...
  const roleLabels: Record<AdminRole, string> = {
    ...
    'GENERAL_MANAGER': 'Executive General Operations Command',
    'PROJECTS_EXECUTION_ENGINEER': 'Field Execution & Site Splicing Directorate',
    'ARCHITECT': 'Design Innovation & Master Planning'
  };
